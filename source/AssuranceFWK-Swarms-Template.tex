...
\subsubsection{wp3}
\ \textbf{Using the Structural, Organisational, Technological, Epistemic, and Cultural (SOTEC) framework for a sociotechnical requirements analysis of autonomous robotic swarms}

In this section, we provide some background to the Structural, Organisational, Technological, Epistemic, and Cultural (SOTEC) framework of sociotechnical risk in Autonomous and Intelligent systems (AIS) (Macrae, 2021) and discuss its relevance for the design of sociotechnical requirements corresponding to autonomous robotic swarms in a cloakroom scenario. These considerations suggest that the requirements engineering process can benefit from a framework that systematically puts forward five sociotechnical sources of risk and failure in AIS, and shows that in this relatively new framework of risk research engineers and researchers are able to build up AIS-informed safety requirements in which safety considerations become meaningful across a network of organisational, contextual, and human factors. The spotlight on sociotechnical sources of risk in AIS throughout section one provides a crucial launching point for the identification of sociotechnical requirements, and the crafting of five dimensions of requirements for autonomous robotic swarms, and as a safety assurance mechanism. The exact meaning of sociotechnical requirements is the topic of the second section. Viewing requirement analysis from a sociotechnical perspective allows us to move away from a purely technical conception of requirements, and helps us design autonomous systems that better fit the organisation and operators’ work in which safety considerations are meaningful within the wider system and operational context. \\ 



\textit{The relevance of the SOTEC framework for sociotechnical requirements}

The focus of much work to date on the design of autonomous systems and specification techniques to assure safety in these systems has primarily been on developing technical aspects of assurance \cite{brundage2020toward}. However, despite significant investments and efforts, getting technical safety assurance right has proved to be a challenging task (see, for instance, Karvonen et al., 2020; Thieme et al., 2021; Hernandez et al., 2021). This is especially the case with some of the most visible and lethal failures that have emerged from recent efforts to develop AIS, where many failures were unforeseen, and therefore untested and unmanaged – such as the latent problem with Uber’s self-driving computer vision system which led to the first pedestrian death involving a self-driving car (Niedermeyer, 2019), or object classification failures with the STM Kargu-2 lethal autonomous weapons system that may have “hunted down and remotely engaged” retreating soldiers in Libya (Nasu, 2021), or a “faulty AI” for skin cancer diagnosis which led to clinical experts producing misleading results (Tschandl et al., 2020). The causes for problems such as these are complex and varied and remain poorly understood. Simplistic claims that technical assurance will reduce risk to technological performance ignores the inherently sociotechnical nature of autonomous and intelligent systems: the fact that “all technologies are designed, developed, built, deployed, maintained, supervised, operated, and governed by people; and those people necessarily work within, and are shaped by, complex social, cultural, and organisational processes” makes assurance extremely complex (Macrae, 2021: 3; Pettersen Gould, 2021; Reason, 1997). Macrae (2021) points out that researchers involved in developing technical aspects of assurance in the development of autonomous systems need to consider the complex sociotechnical sources of risk and failure that can emerge in the design, use, and control of autonomous and intelligent systems. For example, using the 2018 Uber autonomous vehicle crash as a focused case study, Macrae (2021) found that there are five intersecting dimensions along which sociotechnical risk in autonomous systems can be perceived: Structural, Organisational, Technological, Epistemic, and Cultural (‘SOTEC’). 

Structural sources of risk arise from the way different parts or activities in a system interact with each other, and shape how failures evolve. For example, the functional structure of the Uber perception software failed multiple times to correctly classify the pedestrian crossing the road, then prevented the prediction system from calculating a predicted path for the hazard, then prevented the motion planning system to apply emergency brakes (“failure cascades”) (Macrae, 2021: 8). Organisational sources of risk emerge when organisations are insensitive to human contexts and organisational processes are ineffective at detecting and managing errors or disruptions. For example, it was found that there were weaknesses in organisational arrangements to support, monitor, and assure the activities of supervising automated systems (“supervisory degradation”), and that regulatory oversight was entirely absent in the monitoring of safety performance during the development and testing phases in Arizona (“regulatory voids”) (Macrae, 2021: 9). 

Technological sources of risk arise from the specific capabilities and constraints inscribed into and produced by the material technologies of the system. For example, the Uber’s self-driving software was reportedly designed to inadvertently hide, disguise or render ambiguous the presence of potential hazards (“hazard masking”), and ignore perceived hazards in order to place constraints on excessive breaking and smooth the vehicle’s motion (“sensitivity smoothing”) (Macrae, 2021: 10). Epistemic sources of risk arise from the ways that human knowledge is often incomplete, wrong, or out of date, allowing pockets of ignorance – such as professional boundaries or isolated organisations – to hide unexpected threats. For example, the engineers and computer scientists developing the Uber AV were hampered by delays and limitations in the capacity to analyse and review operational events (e.g., ‘near-miss’ events) which produced out of date data (“learning lag”) (Macrae, 2021: 12), and efforts to gather rich data and insights into the on-road behaviour of vehicles were not fully engaged with (“operational disengagement”). Cultural sources of risk arise from the cultural aspects of everyday life that are at the base of human perception, suggesting that cultural characteristics can act as sources of risk because they inform our collective values, beliefs, norms and practices which surround and shape AIS. For example, in the Uber accident, a range of cultural factors were identified, including staff who were disempowered or discouraged in raising safety concerns, speaking up, or challenging assumptions due to fears of punitive responses or lack of support (“concern quashing”), and faulty assumptions regarding the efficacy of human vigilance for monitoring complex automated systems for long periods of time and beliefs that operators required little support or monitoring during on-road testing (“presumptive reliability”).

Drawing these sources of risk together, we suggest that the framework may be concerned with identifying sources of risk, but also with demonstrating a particular framework for evaluating sociotechnical requirements for autonomous robotic swarms embedded in a cloakroom in the context of human engagements with emergent behaviour.\\ 

\textit{Sociotechnical Requirements analysis for autonomous robotics swarms}

Requirements engineering can never be an entirely formal process, because its very nature is to try and understand the users’ needs or objectives, and reconcile them with technical possibilities (Goguen, 1993).
