...
Cloakroom: Performance Requirements (see Table~\ref{tab:perormance}).
\begin{table}[!t]
	\centering
...
\end{table}    
Cloakroom: Adaptability Requirements (see Table~\ref{tab:adaptability}).
\begin{table}[!h]
	\centering
	\begin{tabular}{|p{7mm}|p{72mm}|}
		\hline
...
\end{table}   
Metric: Swarm waiting time/time-in-area.

Cloakroom: Human Safety Requirements (see Table~\ref{tab:human-s}).
\begin{table}[!h]
	\centering
...
Cloakroom: Environmental Specification (see Table~\ref{tab:environment}).
\begin{table}[!h]
	\centering
	\begin{tabular}{|p{7mm}|p{72mm}|}
		\hline
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{figures/amlas-a-stage6_v2.png}%amlas-a-stage6.png
